...
const MT_RECON_L5 = {
  ...
  "guidedLesson": {
    "steps": [
      ...
      {
        "prof": {
          "message": "Criamos q1 e a aresta a;A,R: em q0, ao ler 'a', vamos para q1, escrevemos 'A' e movemos à DIREITA.",
          "mood": "explicando"
        },
        "stateUpdate": {
          "nodes": [
      ...
      {
        "prof": {
          "message": "Criamos q2 e a aresta d;D,L: em q1, ao ler 'd', vamos para q2, escrevemos 'D' e movemos à ESQUERDA.",
          "mood": "explicando"
        },
        "stateUpdate": {
          "nodes": [
