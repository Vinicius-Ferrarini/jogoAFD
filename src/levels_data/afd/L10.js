...
function buildLessonL10() {
  const b = makeBuilder(LEVEL_GRAPHS[10], {
    q0: [22, 34], q1: [43, 35], q2: [69, 36], q3: [23, 61], q4: [70, 65],
  });
  const steps = [];
  b.addNodes('q0', 'q1', 'q2').addEdges(['q0', 'b', 'q1'], ['q1', 'b', 'q2']);
  steps.push(b.draw('Menor palavra "bb" (o núcleo fixo): q0—b→q1—b→q2 (final).', -1));
  steps.push(b.test('Veja "bb" percorrer o núcleo até q2 (final). Aceita!', 'bb', 0));
  b.addNodes('q3').addEdges(['q0', 'a', 'q3'], ['q3', 'a', 'q0']);
  steps.push(b.draw('Adicionamos o vai-e-volta q0↔q3 para o prefixo PAR de "a"s.', 1));
  steps.push(b.reject('Mas "abb" tem 1 "a" (ímpar) antes do núcleo: trava em q3!', 'abb', 1));
  steps.push(b.test('Já "aabb" tem 2 "a"s (par): volta a q0 e segue para o núcleo. Aceita!', 'aabb', 1));
  b.addNodes('q4').addEdges(['q2', 'a', 'q4'], ['q4', 'a', 'q2']);
  steps.push(b.draw('E o vai-e-volta q2↔q4 para o sufixo PAR de "a"s.', 2));
...
export default { id: 10, label: "L10", formula: "L = {a^n b b a^m / n >= 0 é par, m >= 0 e m é par}",                 desc: "",                                                                 shortestWord: "bb",       regex: /^(aa)*bb(aa)*$/,                                            alphabet: ['a', 'b'],             acceptedWords: ["bb","aabb","bbaa"],        rejectedWords: ["abb","bba","b"],       hint: "Começa com 'a's pares (ou zero), o núcleo é 'bb', termina com 'a's pares.",                                        successMsg: "Núcleo isolado com sucesso!",
    tutorials: {
      ...
      onDrawGraph: { type: 'mechanic', title: 'Três Zonas no Grafo', dialog: [
        'Zona 1 (Esquerda): <b>q0</b>↔<b>q3</b> com "a" — conta a\'s PARES antes do núcleo.',
        'Zona 2 (Centro): <b>q0</b>→<b>q1</b>→<b>q2</b>(final) com "bb" — o núcleo fixo.',
        'Zona 3 (Direita): <b>q2</b>↔<b>q4</b> com "a" — conta a\'s PARES após o núcleo!',
      ] },
    },
