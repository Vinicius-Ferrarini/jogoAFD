...
function buildLessonL51() {
  const b = makeBuilder(LEVEL_GRAPHS[51], {
    q0: [12, 35], q1: [27, 36], q2: [28, 69], q3: [50, 17], q4: [53, 93], q5: [79, 36], q6: [80, 72],
  });
  const steps = [];
