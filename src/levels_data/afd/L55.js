    ...
    guidedLesson: [
      ...
      { text: 'Solução: quadrado ab. q0↔q1(a), q0↔q2(b), q1↔q3(b), q2↔q3(a). "aabb"✓. Próxima: "aabbccdd"!',
        boardDoneUpTo: 2, stateUpdate: {
          nodes: [
            { id: 'q0', label: 'q0', x: 240, y: 880, isInitial: true,  isFinal: true  },
            { id: 'q1', label: 'q1', x: 240, y: 1120, isInitial: false, isFinal: false },
            { id: 'q2', label: 'q2', x: 740, y: 880, isInitial: false, isFinal: false },
            { id: 'q3', label: 'q3', x: 740, y: 1120, isInitial: false, isFinal: false },
          ],
          transitions: [
      ...
      { text: 'Solução parcial: +q4(cd-pares,f), q5(c-ímpar), q6(d-ímpar), q7(c-ímpar,d-ímpar). "aabbccdd"✓ O AFD completo tem >80 estados!',
        boardDoneUpTo: 3, stateUpdate: {
          nodes: [
            ...
            { id: 'q2', label: 'q2', x: 740, y: 880, isInitial: false, isFinal: false },
            { id: 'q3', label: 'q3', x: 740, y: 1120, isInitial: false, isFinal: false },
            { id: 'q4', label: 'q4', x: 1240, y: 880, isInitial: false, isFinal: true  },
            { id: 'q5', label: 'q5', x: 1740, y: 880, isInitial: false, isFinal: false },
            { id: 'q6', label: 'q6', x: 1240, y: 1120, isInitial: false, isFinal: false },
            { id: 'q7', label: 'q7', x: 1740, y: 1120, isInitial: false, isFinal: false },
          ],
          transitions: [
            { from: 'q0', to: 'q1', symbol: 'a' }, { from: 'q1', to: 'q0', symbol: 'a' },
            { from: 'q2', to: 'q3', symbol: 'a' }, { from: 'q3', to: 'q2', symbol: 'a' },
