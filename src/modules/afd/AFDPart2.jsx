...
export default function AFDPart2({ onBack, showToast, forceLevelId, forceLevelLabel, progress: externalProgress, updateProgress: externalUpdateProgress, onForcedPrev, onForcedNext }) {
